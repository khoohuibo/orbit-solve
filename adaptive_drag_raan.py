...
secondSequence = [
    AbsoluteDate(2025, 10, 1, 0, 0, 00.000, utc),
    AbsoluteDate(2025, 10, 17, 0, 0, 00.000, utc),
    AbsoluteDate(2025, 10, 30, 0, 0, 00.000, utc),
    [False, False, False, False, False], [False, False]]

thirdSequence = [
    AbsoluteDate(2025, 10, 18, 0, 0, 00.000, utc),
    AbsoluteDate(2025, 10, 30, 0, 0, 00.000, utc),
    AbsoluteDate(2025, 11, 9, 0, 0, 00.000, utc),
    [False, False, False, False, False], [False, True]]

fourSequence = [
    AbsoluteDate(2026, 3, 1, 0, 0, 00.000, utc),
    AbsoluteDate(2026, 3, 4, 0, 0, 00.000, utc),
    AbsoluteDate(2026, 3, 5, 0, 0, 00.000, utc),
    [False, False, False, False, False], [False, False]]
...
with open('output_sso/adaptive_drag_scenario.csv', 'w') as f:
    writer = csv.writer(f)
