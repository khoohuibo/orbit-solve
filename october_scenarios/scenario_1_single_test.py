...
from lib.propagator import set_up_prop
import math
...
propagator, _ = set_up_prop(i, omega, raan, lv, start_date, inertialFrame, ITRF, rp=rp, ra=ra)
...
while (extrapDate.compareTo(finalDate) <= 0.0):  
    ...
    extrapDate = extrapDate.shiftedBy(30*24*3600.0)

header = ['date', 'beta_angle_sun', 'sma', 'der_sma', 'inc', 'ecc', 'raan', 'aop', 'lv', 'ap_list', 'daily_flux']
