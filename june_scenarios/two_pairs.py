...
astro_pair_2_star_date = Time('2026-01-01T00:00:00.000000000', format='isot', scale='utc')
...
accurate_raan_sso_2 = raan_from_ltan(astro_pair_2_star_date, ltan=10.5 * u.hourangle).value - 360
...
with open('output_sso/pair_2_both_sso.csv', 'w') as f:
    writer = csv.writer(f)
